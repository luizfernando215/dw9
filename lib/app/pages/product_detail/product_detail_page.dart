...
import 'package:dw9_delivery_app/app/core/ui/widgets/delivery_incrment_decrement_button.dart';
...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage({Key? key, required this.product, required this.order}) : super(key: key);
              ...
              Container(
                ...
                child: BlocBuilder<ProductDetailController, int>(
                  builder: (context, amount) {
                    return DeliveryIncrmentDecrementButton(
                      incrementTap: () {
