...
import 'package:dw9_delivery_app/app/pages/order/order_repository.dart';
...
class OrderController extends Cubit<OrderState> {
  ...
  void load(List<OrderProductDto> products) async {
    try {
      ...
      emit(state.copyWith(orderProducts: products, status: OrderStatus.loaded, paymentTypes: paymentTypes));
    } catch (e, s) {
