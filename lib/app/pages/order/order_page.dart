    ...
    return BlocListener<OrderController, OrderState>(
      listener: (context, state) {
        state.status.matchAny(
            ...
            error: () {
              hideLoader();
              showError(state.errorMessage ?? 'Ocorreu um erro desconhecido');
            },
            confirmRemoveProduct: () {
              hideLoader();
              if (state is OrderConfirmDeleteProductState) _showConfirmProductDialog(state);
            },
            emptyBag: () {
              showInfo('Sua sacola está vazia, selecione um produto para realizar seu pedido');
                    ...
                    return SliverList(
                      delegate: SliverChildBuilderDelegate(
                        ...
                        ((context, index) {
                          ...
                          return Column(
                            children: [
                              OrderProductTile(index: index, orderProduct: orderProduct),
                              const Divider(
                                color: Colors.grey,
                              ),
                            ],
